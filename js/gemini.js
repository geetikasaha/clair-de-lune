...
3. Identify the single most dominant planetary energy for this seeker right now.
4. From this exact list, choose the one major arcana card that most resonates with that energy:
${GEMINI_CARD_NAMES.join(', ')}
5. Write a personal reading in Geetika's voice.
...
Respond with ONLY valid JSON — no markdown fences, no text before or after:
{
  ...
  "message": "3 sentences of personal reading in Geetika's voice, addressed as 'you'",
  "guidance": "one closing line — a gentle invitation or direction, not a prediction"
}`;
